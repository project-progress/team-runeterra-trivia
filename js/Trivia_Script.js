...
function updateUserScore() {
    ...
    activeUserLabelXp.innerText = `${quizData[players_array[current_player]].xp} XP`;
}
...
function showResult() {
    ...
    for (const userDataValue of Object.values(quizData)) {
        ...
        // scoreDiv.innerHTML +=
        //     `<span>${userDataValue.name} and congrats! , You got <p>` +
        //     userDataValue.xp / 10 +
        //     "</p> out of <p>" +
        //     userDataValue.questions.length +
        //     "</p></span>";
    }
